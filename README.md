...
**by [4n5rud](https://github.com/4n5rud)** 
...
> AI에게 "이거 구현해줘"라고 맡기고 손 떼기엔 아직 불안한 개발자를 위한 워크플로우
> 하네스입니다. 기능 하나에 집중해 기획서를 먼저 검토받고, 승인받은 범위 안에서만
> 구현하며, 코드 리뷰와 QA를 거친 뒤에야 PR을 엽니다.
...
얹힙니다. 이 하네스는 다르게 설계했습니다 — 한 번에 다 읽히지 않고, 필요한 조각만 그때그때
읽힙니다.
...
핵심 하네스는 일부러 최소한으로 유지했습니다. `docs/adapters/`에 있는 선택 훅 3개는 팀
상황에 따라 켜고 끕니다. 보통 QA(10단계) 직후 또는 PR(15단계) 이후에 끼워 넣습니다.
